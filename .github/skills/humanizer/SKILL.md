...
> - **Title Case** nos headings é o padrão do blog
> - **Listas com header em negrito + dois-pontos** são aceitas quando melhoram a leitura
> - **Construções como "não é só X, é Y"** fazem parte da voz do autor
> - Blockquotes `[!NOTE]`, `[!TIP]`, `[!IMPORTANT]` são usados com frequência
> - ~~Texto tachado~~ é usado para humor e ironia
